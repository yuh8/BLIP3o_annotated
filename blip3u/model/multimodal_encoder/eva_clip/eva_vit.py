...
class EVAEncoderWrapper(nn.Module):
    def __init__(self, vision_tower_pretrained, config):
        ...
        self.config = config
        self.config["vision_tower_path"] = '/fsx/home/jiuhai.chen/.cache/huggingface/hub/models--jiuhai--eva_clip_vision_tower/snapshots/d56fdd92bce281278e37fce27cf46c41f257c334/pytorch_model.bin'
