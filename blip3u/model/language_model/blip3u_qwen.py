...
from blip3u.model.blip3u_arch import blip3uMetaModel, blip3uMetaForCausalLM

from transformers import Qwen2_5_VLConfig, Qwen2_5_VLModel, Qwen2_5_VLForConditionalGeneration

from blip3u.constants import UND_IMAGE_TOKEN_IDX
...
class blip3uQwenConfig(Qwen2_5_VLConfig):
    model_type = "blip3u_qwen"


class blip3uQwenModel(blip3uMetaModel, Qwen2_5_VLModel):
    config_class = blip3uQwenConfig

    def __init__(self, config: Qwen2_5_VLConfig):
        super(blip3uQwenModel, self).__init__(config)


class blip3uQwenForCausalLM(Qwen2_5_VLForConditionalGeneration, blip3uMetaForCausalLM):
    config_class = blip3uQwenConfig

    def __init__(self, config):
        Qwen2_5_VLForConditionalGeneration.__init__(self, config)
        config.model_type = "blip3u_qwen"

        self.model = blip3uQwenModel(config)
...
AutoConfig.register("blip3u_qwen", blip3uQwenConfig)
AutoModelForCausalLM.register(blip3uQwenConfig, blip3uQwenForCausalLM)
