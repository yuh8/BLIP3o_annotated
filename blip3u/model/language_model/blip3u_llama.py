...
from ..blip3u_arch import blip3uMetaModel, blip3uMetaForCausalLM
from blip3u.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_IDX, DEFAULT_IM_START_TOKEN_IDX, DEFAULT_IM_END_TOKEN_IDX
import pdb
...
class blip3uConfig(LlamaConfig):
    model_type = "blip3u_llama"


class blip3uLlamaModel(blip3uMetaModel, LlamaModel):
    config_class = blip3uConfig

    def __init__(self, config: LlamaConfig):
        super(blip3uLlamaModel, self).__init__(config)


class blip3uLlamaForCausalLM(LlamaForCausalLM, blip3uMetaForCausalLM):
    config_class = blip3uConfig

    def __init__(self, config):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = blip3uLlamaModel(config)
...
AutoConfig.register("blip3u_llama", blip3uConfig)
AutoModelForCausalLM.register(blip3uConfig, blip3uLlamaForCausalLM)
